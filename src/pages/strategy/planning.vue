  ...
  <div>
    ...
    <div class="px-34 py-20">
      <div class="flex items-center gap-4 border-b border-[#001949] pl-4 pb-4 my-10 ">
        ...
        <span class="text-[#001949] text-4xl font-bold">{{ t('pages.planning.focused.title') }}</span>
      </div>
      <div class="px-4 leading-10">
        <p class="text-[#082867] text-[23px]">{{ t('pages.planning.focused.desc') }}</p>
      </div>
      <div class="flex items-center gap-4 border-b border-[#001949] pl-4 pb-4 mt-20 mb-10 ">
        <img src="@/assets/images/home/rightArr.png" alt="" srcset="" class="w-10">
        <span class="text-[#001949] text-4xl font-bold">{{ t('pages.planning.strengths.title') }}</span>
      </div>
      <div class="py-4 ">
        <img src="@/assets/images/strategy/planning/image1.png" alt="" srcset="" class="w-full">
      </div>
      <div class="flex items-center gap-4 border-b border-[#001949] pl-4 pb-4 mt-20  mb-10">
        <img src="@/assets/images/home/rightArr.png" alt="" srcset="" class="w-10">
        <span class="text-[#001949] text-4xl font-bold">{{ t('pages.planning.investment.title') }}</span>
      </div>
      <div class="px-4 leading-10">
        <p class="text-[#082867] text-[23px]">{{ t('pages.planning.investment.desc') }}</p>
      </div>
      <div class="flex items-center gap-4 border-b border-[#001949] pl-4 pb-4 mt-20 mb-10 ">
        <img src="@/assets/images/home/rightArr.png" alt="" srcset="" class="w-10">
        <span class="text-[#001949] text-4xl font-bold">{{ t('pages.planning.Cases') }}</span>
      </div>
      <div class="p-4 ">
